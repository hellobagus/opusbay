...
class MyNup extends Component {
    ...
    handleChooseNup(data) {
        // console.log('check nupss', this.state.nupss);
        const getdataNup = this.state.nupss;
        Actions.NupDetails({nupss : data, prevItems: this.props.items})
                            ...
                            <Card style={{
                                ...
                                <View>
                                    ...
                                    <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                                        ...
                                        {
                                               data.nup_no && data.nup_no.length > 0 ?
                                               <Text style={{
                                                    fontSize: 12,
                                                    fontWeight: '500',
                                                    textAlign: 'right',
