...
class NUPPage extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            // getAgentcd: [],
            // business_id: [],
            replaceFoto: "file:///TuansingAPI2/images/noimage.png",
    ...
    unitChanges(i, value) {
        ...
        //     this.setState({ 
        //         units: this.state.units.filter(val => val.lot_no != value.lot_no),
        //         getunits: { ...this.state.getunits, [i]: value }
        //     });
        // }
        // var toUnits = [...this.state.units];
                        ...
                        <ScrollView>
                            ...
                            {/* <View style={Styles.overview}>
                                <Text style={Styles.overviewTitle}>Choice of Units</Text>
                                {
                                    this.state.qtys.map((data,key)=>
                                        <View key={key}>
                                            {
                                                this.state.getunits[data] 
                                                ?   <Text>{`${this.state.getunits[data].lot_no} - ${this.state.getunits[data].types}`}</Text>
                                                :   <Picker note 
                                                        mode="dropdown"
                                                        style={Styles.textInput}
                            ...
                            {/* <View style={Styles.overview}>
                                ...
                                <Picker note
                                    mode="dropdown"
                                    style={Styles.textInput}
                                    selectedValue={this.state.producttp}
                                    onValueChange={(val)=>this.selectNupType(val)}
                                >
                                    <Picker.Item label="Choose Product Type" />
                                    {this.state.product_type.map((data, key) =>
                                        <Picker.Item key={key} label={data.descs} value={data.product_cd} />
                                    )}
                                </Picker>
                                
                                {this.state.errorproducttp ? (
                                        <Text
                                            style={{
                                                position: "absolute",
                                                bottom: 0,
                            ...
                            <View style={Styles.overview}>
                                <Text style={Styles.overviewTitle}>Choose Property</Text>
                                <Picker note
                                    mode="dropdown"
                                    style={Styles.textInput}
                                    selectedValue={this.state.getpropertys}
                                    onValueChange={(val)=>this.selectUnits(val)}
                                >
                                    <Picker.Item label="Choose Property" />
                                    {this.state.pproperty.map((data, key) =>
                                        <Picker.Item key={key} label={data.descs} value={data} />
                                    )}
                                </Picker>
                                
                                {this.state.errorgetpropertys ? (
                                        <Text
                                            style={{
                                                position: "absolute",
                                                bottom: 0,
