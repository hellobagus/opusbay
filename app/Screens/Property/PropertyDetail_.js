  ...
  .then((res)=>{
      if(!res.Error){
          ...
          resData.plans.map((item)=>{
            this.setState(prevState=>({
              unitPlanReview : [...prevState.unitPlanPreview, {url:item.plan_url}]
            }))
          })
      } else {
          this.setState({isLoaded: !this.state.isLoaded},()=>{
    ...
    return (
      <Container style={Style.bgMain}>
        <Header style={Style.navigation}>
          <StatusBar backgroundColor={Colors.statusBarBlue} animated barStyle="light-content" />          
          ...
          <Tabs locked={Platform.OS == 'android' ? true : false} tabBarUnderlineStyle={Styles.tabBorder}>
            ...
            >
              <List style={Styles.infoTab}>
                <View style={Styles.overview}>
                  {/* <Text style={Styles.overviewTitle}></Text> */}
                    {this.state.feature ? 
            ...
            >
              <List style={Styles.infoTab}>
                <View style={Styles.overview}>
                  <Text style={Styles.overviewTitle}>Unit Plans</Text>
                  {this.state.plans ?
                  <FlatList
                    ...
                    <List style={Styles.infoTab}>
                      <View style={Styles.overview}>
                        {/* <Text style={Styles.overviewTitle}>Infrastructure</Text> */}
                          ...
                          :
                          // <ActivityIndicator />
                          <Text style={Styles.overviewTitle_surround}>No Data</Text>
                          }
                      </View>
                    </List>
                  </Tab>
