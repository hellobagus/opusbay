                ...
                <View>
                    <View style={styles.overview}>
                        ...
                        <Button style={styles.btn} onPress={()=>this.count()}>
                            <Text style={styles.formBtnText}>{"Count".toUpperCase()}</Text>
                    ...
                    <View style={styles.overview}>
                        ...
                        <Text style={styles.countText}>
                        * the rate above are estimated rate, for more accuracy please contact the relevant bank.
                        </Text>
                    </View>
                </View>
             </Content>
